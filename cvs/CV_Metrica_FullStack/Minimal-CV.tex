    ...
    rowspan=\headboxheight}
{
    ...
    \end{tikzpicture}
    \\[4pt]
    \titlefont{Full Stack Developer -- Java \& Angular}
}
    ...
    rowspan=\mainboxheight}
{
    \begin{tabular}{rl}
        ...
        \multirow{2}{*}{\scalebox{0.075}{\input{icons/link.tex}}}
        ...
        \multirow{2}{*}{\scalebox{0.075}{\input{icons/person.tex}}}
            & \textbf{Rodrigo E. Tufino} \\
            & Docente UPS \\
            & \href{mailto:rtufino@ups.edu.ec}{rtufino@ups.edu.ec} \\
            & \smallspace

        \multirow{4}{*}{\scalebox{0.075}{\input{icons/person.tex}}}
        ...
        \multirow{2}{*}{\scalebox{0.075}{\input{flags/ecuador.tex}}}
            & \textbf{Espa\~{n}ol} \\
            & Nativo \\
            & \smallspace
...
Desarrollador Full Stack con dominio en Java y Spring Boot para el backend, y Angular y Node.js para el frontend e integraciones. Experiencia construyendo APIs RESTful con autenticaci\'{o}n JWT, bases de datos PostgreSQL y MySQL, y trabajo en equipo sobre plataformas reales en producci\'{o}n. Ingl\'{e}s B2.
} \\
...
\begin{tabularx}{\linewidth}{>{\footnotesize\raggedleft}p{1.6cm} X}
    ...
    \textbf{Backend}
        & Java 21, Java 11, Spring Boot 3, Spring Security, JWT, APIs REST, JDBC, JPA, JSP, Servlets \\
        & \smallspace

    \textbf{Frontend}
        & Angular 17/19, TailwindCSS 4 \\
        & \smallspace
